export default function({ id, className, width, height, fillColor, title, onClick }) {
    return (
        <svg
        id = {id}
        className = {className}
