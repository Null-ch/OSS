        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <div class="row">
                            <h2>Просмотр данных о доставке</h2>
                            <div class="col-2">
                                <a href="{{ route('admin.delivery.edit', $delivery->id) }}" class="text-success"><i class="fas fa-pencil-alt  pt-3"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Просмотр данных о доставке</li>
                        </ol>
                    </div>
                </div>
                                ...
                                <table class="table table-hover text-nowrap">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $delivery->title }}</td>
                                            <td class="text-center">{{ $delivery->created_at }}</td>
                                            <td class="text-center">{{ $delivery->updated_at }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
